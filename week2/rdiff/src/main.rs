...
fn main() {
    ...
    let lines1 = read_file_lines(&filename1).expect("Error opening file 1");
    let lines2 = read_file_lines(&filename2).expect("Error opening file 1");
